...
export default function CommandInput({ onCommand }) {
    ...
    return (
        <div className="flex justify-center my-6">
            <form onSubmit={handleSubmit} className="blueprint-border bg-blueprint-dark/30 p-6 w-full max-w-3xl" role="form" aria-label="Command input form">
                <div className="mb-3">
                    <label htmlFor="command-input" className="blueprint-text text-sm tracking-wider">TERMINAL INPUT</label>
                </div>
                <div className="flex gap-3">
                    <div className="flex-1 relative">
                        <span className="absolute left-3 top-1/2 -translate-y-1/2 text-white/70 font-mono text-sm" aria-hidden="true">
                            &gt;
                        </span>
                        <input 
                            id="command-input"
                ...
                <div id="command-help" className="mt-3 text-white/50 text-xs font-mono">
